...
- **v2.3 Notes Simplification** — Phases 34-36 (SHIPPED 2026-01-27)
...
<details>
<summary>v2.1 User Notes (Phases 28-30) — SHIPPED 2026-01-27</summary>

User annotations on config options, stored as JSON files mirroring the config structure.

- [x] Phase 28: Notes Database (1/1 plans) — completed 2026-01-27
- [x] Phase 29: Notes UI (1/1 plans) — completed 2026-01-27
- [x] Phase 30: Notes Integration (1/1 plans) — completed 2026-01-27 (work done in Phase 29)
...
<details>
<summary>v2.3 Notes Simplification (Phases 34-36) — SHIPPED 2026-01-27</summary>

Simplified notes storage to per-schema files. Notes for a config key are now shared across all categories.

- [x] Phase 34: Notes Schema Refactor (1/1 plans) — completed 2026-01-27
- [x] Phase 35: Notes UI Update (0/0 plans) — completed 2026-01-27 (done in Phase 34)
- [x] Phase 36: Migration & Cleanup (0/0 plans) — completed 2026-01-27 (not needed)
...
| 34. Notes Schema Refactor | v2.3 | 1/1 | Complete | 2026-01-27 |
| 35. Notes UI Update | v2.3 | 0/0 | Complete | 2026-01-27 |
| 36. Migration & Cleanup | v2.3 | 0/0 | Complete | 2026-01-27 |
